...
type public when_it_gets_a_ping() = 
  inherit AkkaTestBase() 
     ...
     member public  this.it_should_do_a_pong_integration() =
        ...
        //Assert
        this.AwaitAssert  (fun m->this.Subscriber.ExpectMsg<PongMessage>() |> ignore),TimeSpan.FromSeconds(20.0)|> ignore
     ...
     member  public  this.it_should_do_a_pong_unit1() =
        ...
        //Assert
        this.AwaitAssert  (fun m->this.ExpectMsg<PingMessageCompleted>()|> ignore),TimeSpan.FromSeconds(20.0) |> ignore
     ...
     member public this.it_should_do_a_pong_unit2() =
        ...
        //Assert
        this.AwaitAssert  (fun m->this.ExpectMsg<SorryImStashing>()|> ignore),TimeSpan.FromSeconds(5.0) |> ignore
